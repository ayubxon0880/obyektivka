                ...
                {formData.educations.map((education, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                <label htmlFor={`education-year-${index}`}
                                       className="block text-sm font-medium text-gray-700">
            ...
            <div className="border-b border-gray-200 pb-6">
                ...
                {formData.academicDegrees.map((degree, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label htmlFor={`degree-name-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                            ...
                            <div>
                                <label htmlFor={`degree-year-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                                    Yili <span className="text-red-500">*</span>
                                </label>
                                <input
                            ...
                            <div>
                                <label htmlFor={`degree-field-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                ...
                {formData.academicTitles.map((title, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor={`title-name-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                            ...
                            <div>
                                <label htmlFor={`title-year-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                                    Yili <span className="text-red-500">*</span>
                                </label>
                                <input
                ...
                {formData.foreignLanguages.map((lang, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label htmlFor={`language-level-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                                    Darajasi <span className="text-red-500">*</span>
                                </label>
                                <input
                ...
                {formData.awards.map((award, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label htmlFor={`award-year-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                                    Yili <span className="text-red-500">*</span>
                                </label>
                                <input
            ...
            <div className="border-b border-gray-200 pb-6">
                ...
                {formData.workExperiences.map((exp, index) => (
                    <div key={index} className="mt-4 space-y-4 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor={`work-position-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                            ...
                            <div>
                                <label htmlFor={`work-organization-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor={`work-start-${index}`}
                                       className="block text-sm font-medium text-gray-700">
                        ...
                        <div>
                            <label htmlFor={`work-responsibilities-${index}`}
                                   className="block text-sm font-medium text-gray-700">
                                Vazifalari
                            </label>
                            <textarea
            ...
            <div className="border-b border-gray-200 pb-6">
                ...
                {formData.familyRelations.map((relation, index) => (
                    <div key={index} className="mt-6 border border-gray-200 p-4 rounded-lg relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor={`relationType-${index}`}
                                       className="block text-sm font-medium text-gray-700">
